- (http://localhost/Flashcard_Application/index.php)
...
- There are two sidebar menu and the first one is that you can retrieve,insert,update,delete for FlashCard.

- The second is that you can view your flashcard and study by flipping.
